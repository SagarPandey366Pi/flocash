...
package org.floj.store;

import com.google.protobuf.ByteString;

import org.floj.core.*;
import org.floj.core.Transaction.Purpose;
...
import org.floj.params.UnitTestParams;
import org.floj.script.ScriptBuilder;
import org.floj.store.MemoryBlockStore;
import org.floj.testing.FakeTxBuilder;
import org.floj.testing.FooWalletExtension;
...
public class WalletProtobufSerializerTest {
    ...
    public void oneTx() throws Exception {
        ...
        assertArrayEquals(t1.unsafeFLOSerialize(), t1copy.unsafeFLOSerialize());
    ...
    public void coinbaseTxns() throws Exception {
        ...
        Block b = PARAMS.getGenesisBlock().createNextBlockWithCoinbase(Block.BLOCK_VERSION_GENESIS, myKey.getPubKey(), HUNDRED_COINS, Block.BLOCK_HEIGHT_GENESIS);
