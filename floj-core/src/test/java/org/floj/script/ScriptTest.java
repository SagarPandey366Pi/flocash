...
import org.floj.script.Script.VerifyFlag;
...
import static org.floj.script.ScriptOpCodes.OP_0;
import static org.floj.script.ScriptOpCodes.OP_INVALIDOPCODE;
...
public class ScriptTest {
    ...
    public void createAndUpdateEmptyInputScript() throws Exception {
        ...
        assertThat(inputScript.getChunks().get(0).data, equalTo(dummySig.encodeToFLO()));
        ...
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToFLO()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeToFLO()));
        ...
        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToFLO(), 0, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToFLO()));
        assertThat(inputScript.getChunks().get(2).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));

        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToFLO(), 1, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToFLO()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeToFLO()));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));
        ...
        try {
            ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToFLO(), 1, 1, 1);
    ...
    public void dataDrivenInvalidTransactions() throws Exception {
        ...
        for (JsonNode test : json) {
            ...
            // FLO Core checks this case in CheckTransaction, but we leave it to
