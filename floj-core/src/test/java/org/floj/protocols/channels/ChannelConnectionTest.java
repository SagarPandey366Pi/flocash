...
import org.flo.paymentchannel.Protos;
import org.floj.core.*;
import org.floj.protocols.channels.PaymentChannelClient;
import org.floj.protocols.channels.PaymentChannelClientConnection;
import org.floj.protocols.channels.PaymentChannelClientState;
import org.floj.protocols.channels.PaymentChannelCloseException;
import org.floj.protocols.channels.PaymentChannelServer;
import org.floj.protocols.channels.PaymentChannelServerListener;
...
import org.floj.protocols.channels.PaymentIncrementAck;
import org.floj.protocols.channels.ServerConnectionEventHandler;
import org.floj.protocols.channels.StoredPaymentChannelClientStates;
import org.floj.protocols.channels.StoredPaymentChannelServerStates;
import org.floj.protocols.channels.StoredServerChannel;
import org.floj.testing.TestWithWallet;
import org.floj.utils.Threading;
import org.floj.wallet.Wallet;
import org.floj.wallet.WalletExtension;
...
import static org.flo.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
import static org.floj.core.Coin.*;
import static org.floj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.floj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.floj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
