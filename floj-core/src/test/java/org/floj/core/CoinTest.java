...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 FLO", COIN.toFriendlyString());
        assertEquals("1.23 FLO", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 FLO", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 FLO", valueOf(1, 23).negate().toFriendlyString());
    }
