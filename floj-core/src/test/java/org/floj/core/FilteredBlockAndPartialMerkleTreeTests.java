...
import org.floj.core.PartialMerkleTree;
...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void createFilteredBlock() throws Exception {
        ...
        Transaction tx2 = FakeTxBuilder.createFakeTx(PARAMS, Coin.HUNDRED_COINS, key2.toAddress(PARAMS));
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        // Note that all serialized forms here are generated by FLO Core/pulled from block explorer
        ...
        assertArrayEquals(HEX.decode("0e1b091ca195e45a9164889b6bc46a09000000efbeadde02"), filter.unsafeFLOSerialize());
