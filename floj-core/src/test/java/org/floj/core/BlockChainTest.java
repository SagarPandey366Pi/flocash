...
public class BlockChainTest {
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        assertEquals(Coin.ZERO, wallet.getBalance());
        assertEquals(wallet.getBalance(BalanceType.ESTIMATED), HUNDRED_COINS);
        ...
        assertEquals(wallet.getBalance(), HUNDRED_COINS);
        assertEquals(wallet.getBalance(BalanceType.ESTIMATED), HUNDRED_COINS);
        assertTrue(coinbaseTransaction.isMature());

        // Create a spend with the coinbase FLO to the address in the second wallet - this should now succeed.
