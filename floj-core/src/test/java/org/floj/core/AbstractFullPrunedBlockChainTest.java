...
import org.floj.core.StoredUndoableBlock;
...
import org.floj.core.TransactionOutputChanges;
...
import org.floj.store.FullPrunedBlockStore;
import org.floj.utils.BlockFileLoader;
...
import static org.floj.core.Coin.HUNDRED_COINS;
...
public abstract class AbstractFullPrunedBlockChainTest {
    ...
    public void skipScripts() throws Exception {
        ...
        t.addOutput(new TransactionOutput(PARAMS, t, HUNDRED_COINS, new byte[] {}));
    ...
    public void testUTXOProviderWithWallet() throws Exception {
        ...
        // Create 1 FLO spend to a key in this wallet (to ourselves).
        ...
        // Create another spend of 1/2 the value of FLO we have available using the wallet (store coin selector).
        ...
        // The availbale balance should be the 0 (as we spent the 1 FLO that's pending) and estimated should be 1/2 - fee FLO
        assertEquals("Available balance is incorrect", Coin.ZERO, wallet.getBalance(Wallet.BalanceType.AVAILABLE));
