...
import org.floj.core.GetBlocksMessage;
...
import org.floj.core.NotFoundMessage;
import org.floj.core.Peer;
import org.floj.core.PeerAddress;
import org.floj.core.Ping;
import org.floj.core.Pong;
...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void noPings() throws Exception {
        ...
        versionMessage.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getFLOProtocolVersion();
    ...
    public void downloadPeerSelection() throws Exception {
        ...
        versionMessage2.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getFLOProtocolVersion();
        versionMessage2.localServices = VersionMessage.NODE_NETWORK;
        VersionMessage versionMessage3 = new VersionMessage(PARAMS, 3);
        versionMessage3.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getFLOProtocolVersion();
    ...
    public void testBloomOnP2Pubkey() throws Exception {
        ...
        assertTrue(p3.lastReceivedFilter.contains(outpoint.unsafeFLOSerialize()));
    }
    ...
    public void preferLocalPeer() throws IOException {
        // Because we are using the same port (8333 or 18333) that is used by FLO Core
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        for (ECKey key1 : keys) {
            ...
            Block next = FakeTxBuilder.makeSolvedTestBlock(prev, FakeTxBuilder.createFakeTx(PARAMS, Coin.HUNDRED_COINS, addr));
        ...
        BloomFilter filter = new BloomFilter(PARAMS, p1.lastReceivedFilter.floSerialize());
        ...
        assertEquals(Coin.HUNDRED_COINS.multiply(3), wallet.getBalance());
