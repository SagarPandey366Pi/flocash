...
import org.floj.core.AddressMessage;
...
public class FLOSerializerTest {
    ...
    public void testFLOPacketHeaderTooShort() {
        new FLOSerializer.FLOPacketHeader(ByteBuffer.wrap(new byte[] { 0 }));
    }

    @Test(expected = ProtocolException.class)
    public void testFLOPacketHeaderTooLong() {
        ...
        new FLOSerializer.FLOPacketHeader(ByteBuffer.wrap(wrongMessageLength));
    }
