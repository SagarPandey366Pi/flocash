...
package org.floj.utils;

import org.floj.core.Coin;
import org.floj.utils.BtcAutoFormat;
import org.floj.utils.BtcFixedFormat;
import org.floj.utils.BtcFormat;
...
import static org.floj.core.NetworkParameters.MAX_MONEY;
import static org.floj.utils.BtcAutoFormat.Style.CODE;
import static org.floj.utils.BtcAutoFormat.Style.SYMBOL;
import static org.floj.utils.BtcFixedFormat.REPEATING_DOUBLETS;
import static org.floj.utils.BtcFixedFormat.REPEATING_TRIPLETS;
...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        // Coins
        assertEquals(valueOf(200000000), us.parseObject("FLO2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("FLO 2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("2.0"));
        assertEquals(valueOf(200000000), us.parseObject("FLO2.0"));
        ...
        assertEquals(valueOf(202222420000000L), us.parseObject("FLO2,022,224.20"));
        ...
        // MilliCoins
        assertEquals(valueOf(200000), usCoded.parseObject("mFLO 2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("mFLO2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("₥2"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥FLO 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XBT 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥FLO 2"));
        ...
        assertEquals(valueOf(202222400000L), us.parseObject("₥FLO2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("₥XBT2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("mFLO2,022,224"));
        ...
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥FLO 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥XBT 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mFLO 2,022,224"));
        ...
        assertEquals(valueOf(435), us.parseObject("uFLO4.35"));
        assertEquals(valueOf(435), us.parseObject("uXBT4.35"));
        assertEquals(valueOf(435), us.parseObject("µFLO4.35"));
        assertEquals(valueOf(435), us.parseObject("µXBT4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uFLO 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXBT 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µFLO 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µXBT 4.35"));
        // fractional satoshi; round up
        assertEquals(valueOf(435), us.parseObject("uFLO4.345"));
        ...
        assertEquals(valueOf(-10), us.parseObject("(µFLO0.100)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("FLO 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("FLO1.00"));
        ...
        // milli
        assertEquals(parseCoin("0.001"), cp.parseObject("mFLO 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mFLO1.00"));
        ...
        assertEquals(parseCoin("0.001"), cp.parseObject("₥FLO 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("₥FLO1.00"));
        ...
        // micro
        assertEquals(parseCoin("0.000001"), cp.parseObject("uFLO 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uFLO1.00"));
        ...
        assertEquals(parseCoin("0.000001"), cp.parseObject("µFLO 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("µFLO1.00"));
        ...
        // satoshi
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uFLO 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uFLO0.01"));
        ...
        assertEquals(parseCoin("0.00000001"), cp.parseObject("µFLO 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("µFLO0.01"));
        ...
        // cents
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cFLO 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cFLO1.234567"));
        ...
        assertEquals(parseCoin("0.01234567"), cp.parseObject("¢FLO 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("¢FLO1.234567"));
        ...
        // dekacoins
        assertEquals(parseCoin("12.34567"), cp.parseObject("daFLO 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daFLO1.234567"));
        ...
        // hectocoins
        assertEquals(parseCoin("123.4567"), cp.parseObject("hFLO 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hFLO1.234567"));
        ...
        // kilocoins
        assertEquals(parseCoin("1234.567"), cp.parseObject("kFLO 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kFLO1.234567"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MFLO 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MFLO1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        BtcFormat usCoded = BtcFormat.getCodeInstance(Locale.US);
        assertEquals("µFLO 0.01", usCoded.format(1));
        assertEquals("FLO 1.00", usCoded.format(COIN));

        /* Do not insert unneeded space BEFORE currency-code */
        BtcFormat frCoded = BtcFormat.getCodeInstance(Locale.FRANCE);
        assertEquals("0,01 µFLO", frCoded.format(1));
        assertEquals("1,00 FLO", frCoded.format(COIN));
        ...
        assertEquals("µFLO 0,01", deCoded.format(1));
        assertEquals("FLO 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("FLO 1", codedZero.format(COIN));
        assertEquals("µ฿1,000,000", symbolZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µFLO 1,000,000", codedZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µ฿1,000,000", symbolZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µFLO 1,000,000", codedZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µ฿999,999", symbolZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("µFLO 999,999", codedZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("฿1,000", symbolZero.format(COIN.multiply(1000)));
        assertEquals("FLO 1,000", codedZero.format(COIN.multiply(1000)));
        assertEquals("µ฿1", symbolZero.format(Coin.valueOf(100)));
        assertEquals("µFLO 1", codedZero.format(Coin.valueOf(100)));
        assertEquals("µ฿1", symbolZero.format(Coin.valueOf(50)));
        assertEquals("µFLO 1", codedZero.format(Coin.valueOf(50)));
        assertEquals("µ฿0", symbolZero.format(Coin.valueOf(49)));
        assertEquals("µFLO 0", codedZero.format(Coin.valueOf(49)));
        assertEquals("µ฿0", symbolZero.format(Coin.valueOf(1)));
        assertEquals("µFLO 0", codedZero.format(Coin.valueOf(1)));
        assertEquals("µ฿500,000", symbolZero.format(Coin.valueOf(49999999)));
        assertEquals("µFLO 500,000", codedZero.format(Coin.valueOf(49999999)));

        assertEquals("µ฿499,500", symbolZero.format(Coin.valueOf(49950000)));
        assertEquals("µFLO 499,500", codedZero.format(Coin.valueOf(49950000)));
        assertEquals("µ฿499,500", symbolZero.format(Coin.valueOf(49949999)));
        assertEquals("µFLO 499,500", codedZero.format(Coin.valueOf(49949999)));
        assertEquals("µ฿500,490", symbolZero.format(Coin.valueOf(50049000)));
        assertEquals("µFLO 500,490", codedZero.format(Coin.valueOf(50049000)));
        assertEquals("µ฿500,490", symbolZero.format(Coin.valueOf(50049001)));
        assertEquals("µFLO 500,490", codedZero.format(Coin.valueOf(50049001)));
        assertEquals("µ฿500,000", symbolZero.format(Coin.valueOf(49999950)));
        assertEquals("µFLO 500,000", codedZero.format(Coin.valueOf(49999950)));
        assertEquals("µ฿499,999", symbolZero.format(Coin.valueOf(49999949)));
        assertEquals("µFLO 499,999", codedZero.format(Coin.valueOf(49999949)));
        assertEquals("µ฿500,000", symbolZero.format(Coin.valueOf(50000049)));
        assertEquals("µFLO 500,000", codedZero.format(Coin.valueOf(50000049)));
        assertEquals("µ฿500,001", symbolZero.format(Coin.valueOf(50000050)));
        assertEquals("µFLO 500,001", codedZero.format(Coin.valueOf(50000050)));
        ...
        assertEquals("FLO 1.00", codedTwo.format(COIN));
        assertEquals("µ฿999,999.99", symbolTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("µFLO 999,999.99", codedTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("฿1,000.00", symbolTwo.format(COIN.multiply(1000)));
        assertEquals("FLO 1,000.00", codedTwo.format(COIN.multiply(1000)));
        assertEquals("µ฿1.00", symbolTwo.format(Coin.valueOf(100)));
        assertEquals("µFLO 1.00", codedTwo.format(Coin.valueOf(100)));
        assertEquals("µ฿0.50", symbolTwo.format(Coin.valueOf(50)));
        assertEquals("µFLO 0.50", codedTwo.format(Coin.valueOf(50)));
        assertEquals("µ฿0.49", symbolTwo.format(Coin.valueOf(49)));
        assertEquals("µFLO 0.49", codedTwo.format(Coin.valueOf(49)));
        assertEquals("µ฿0.01", symbolTwo.format(Coin.valueOf(1)));
        assertEquals("µFLO 0.01", codedTwo.format(Coin.valueOf(1)));
        ...
        assertEquals("FLO 1.000", codedThree.format(COIN));
        assertEquals("µ฿999,999.99", symbolThree.format(COIN.subtract(SATOSHI)));
        assertEquals("µFLO 999,999.99", codedThree.format(COIN.subtract(SATOSHI)));
        assertEquals("฿1,000.000", symbolThree.format(COIN.multiply(1000)));
        assertEquals("FLO 1,000.000", codedThree.format(COIN.multiply(1000)));
        assertEquals("₥฿0.001", symbolThree.format(Coin.valueOf(100)));
        assertEquals("mFLO 0.001", codedThree.format(Coin.valueOf(100)));
        assertEquals("µ฿0.50", symbolThree.format(Coin.valueOf(50)));
        assertEquals("µFLO 0.50", codedThree.format(Coin.valueOf(50)));
        assertEquals("µ฿0.49", symbolThree.format(Coin.valueOf(49)));
        assertEquals("µFLO 0.49", codedThree.format(Coin.valueOf(49)));
        assertEquals("µ฿0.01", symbolThree.format(Coin.valueOf(1)));
        assertEquals("µFLO 0.01", codedThree.format(Coin.valueOf(1)));
    }
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 FLO", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("FLO -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("฿ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("FLO -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("฿-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(FLO 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(฿1.00)", BtcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("FLO -१.००", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("FLO -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("FLO") && ! codePat.contains("(^|[^฿])฿([^฿]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("฿") && !symPat.contains("FLO") && !symPat.contains("¤¤"));

        assertEquals("FLO #,##0.00;(FLO #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format FLO #,##0.00;(FLO #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format FLO #,##0.0000;(FLO #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format FLO #.000;FLO -#.000", f.toString());
        assertEquals("mFLO 1000.000", f.format(COIN));
    }
    ...
    public void builderTest() {
        ...
        assertEquals("FLO -1,00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("¤¤##,###.#").scale(3).locale(US).build();
        assertEquals("mFLO1,000.00", built.format(COIN));
        built = BtcFormat.builder().pattern("¤ ##,###.#").scale(3).locale(US).build();
