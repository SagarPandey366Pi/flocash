...
import static org.floj.core.Coin.CENT;
import static org.floj.core.Coin.COIN;
import static org.floj.core.Coin.SATOSHI;
import static org.floj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.FLO.noCode();
    ...
    public void standardCodes() throws Exception {
        assertEquals("FLO 0.00", MonetaryFormat.FLO.format(Coin.ZERO).toString());
        assertEquals("mFLO 0.00", MonetaryFormat.MFLO.format(Coin.ZERO).toString());
        assertEquals("µFLO 0", MonetaryFormat.UFLO.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dFLO 0", MonetaryFormat.UFLO.code(1, "dFLO").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        assertEquals("0", MonetaryFormat.UFLO.noCode().shift(0).format(Coin.ZERO).toString());
        // Ensure that inserting a code after codes are wiped, works
        assertEquals("dFLO 0", MonetaryFormat.UFLO.noCode().code(1, "dFLO").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("FLO 0.00", MonetaryFormat.FLO.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 FLO", MonetaryFormat.FLO.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("FLO@0.00", MonetaryFormat.FLO.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UFLO.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MFLO.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MFLO.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MFLO.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MFLO.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MFLO.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MFLO.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UFLO.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UFLO.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UFLO.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UFLO.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UFLO.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UFLO.parse("-1.0"));
