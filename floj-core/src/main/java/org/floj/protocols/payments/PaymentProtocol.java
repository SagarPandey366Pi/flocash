...
/**
 * <p>Utility methods and constants for working with <a href="https://github.com/flo/bips/blob/master/bip-0070.mediawiki">
...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/flo-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/flo-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/flo-paymentack";
    ...
    public static Protos.Payment createPaymentMessage(List<Transaction> transactions,
        ...
        for (Transaction transaction : transactions) {
            transaction.verify();
            builder.addTransactions(ByteString.copyFrom(transaction.unsafeFLOSerialize()));
        }
