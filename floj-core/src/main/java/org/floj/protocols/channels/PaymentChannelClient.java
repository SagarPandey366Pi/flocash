...
import org.floj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link org.floj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
        ...
        switch (majorVersion) {
            case 1:
                ...
                Protos.ProvideRefund.Builder provideRefundBuilder = Protos.ProvideRefund.newBuilder()
                        ...
                        .setTx(ByteString.copyFrom(((PaymentChannelV1ClientState)state).getIncompleteRefundTransaction().unsafeFLOSerialize()));
            ...
            case 2:
                ...
                Protos.ProvideContract.Builder provideContractBuilder = Protos.ProvideContract.newBuilder()
                        .setTx(ByteString.copyFrom(state.getContract().unsafeFLOSerialize()))
     ...
     * {@link ClientConnection#destroyConnection(org.floj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
    ...
    public ListenableFuture<PaymentIncrementAck> incrementPayment(Coin size, @Nullable ByteString info, @Nullable KeyParameter userKey)
        ...
        try {
            ...
            Protos.UpdatePayment.Builder updatePaymentBuilder = Protos.UpdatePayment.newBuilder()
                    .setSignature(ByteString.copyFrom(payment.signature.encodeToFLO()))
