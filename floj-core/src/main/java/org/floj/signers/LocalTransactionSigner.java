...
import org.floj.wallet.RedeemData;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link org.floj.wallet.KeyBag}.</p>
 ...
 * <p>This signer always uses {@link org.floj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            try {
                ...
                int sigIndex = 0;
                inputScript = scriptPubKey.getScriptSigWithSignature(inputScript, signature.encodeToFLO(), sigIndex);
