...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.floj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.floj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.floj.crypto.KeyCrypter,
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all flo controlled by that private key is lost forever).
