...
import org.floj.crypto.KeyCrypter;
import org.floj.crypto.KeyCrypterScrypt;
import org.floj.script.Script;
import org.floj.signers.LocalTransactionSigner;
...
public class WalletProtobufSerializer {
    ...
    private static Protos.Transaction makeTxProto(WalletTransaction wtx) {
        ...
        if (tx.getFloData().length > 0) {
            txBuilder.setFloData(ByteString.copyFrom(tx.getFloData()));
        }
    ...
    private void readTransaction(Protos.Transaction txProto, NetworkParameters params) throws UnreadableWalletException {
        ...
        if (txProto.hasFloData()) {
//        	System.out.println("txProto.hasFloData()");
        	tx.setFloData(txProto.getFloData().toByteArray());
        }
//        else {
//        	System.out.println("NO txProto.hasFloData()");
//        	tx.setFloData("text:FLO Core to floj testnet first test");
//        }
...
//        System.out.println("tx     :"+b2.toString(16));
    ...
    private WalletTransaction connectTransactionOutputs(final NetworkParameters params,
                                                        final org.floj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
