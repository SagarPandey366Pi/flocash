 ...
 * <a href="https://github.com/flo/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
 * {@link org.floj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.floj.crypto.MnemonicCode},
 ...
 * {@link org.floj.crypto.DeterministicKey#serializePubB58(org.floj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.floj.crypto.DeterministicKey#deserializeB58(org.floj.crypto.DeterministicKey, String, org.floj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.floj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.floj.crypto.DeterministicHierarchy} and
 * {@link org.floj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.floj.crypto.DeterministicKey)}
     ...
     * @see org.floj.wallet.MarriedKeyChain
     */
