...
public class Script {
    ...
    private int findSigInRedeem(byte[] signatureBytes, Sha256Hash hash) {
        checkArgument(chunks.get(0).isOpCode()); // P2SH scriptSig
        int numKeys = Script.decodeFromOpN(chunks.get(chunks.size() - 2).opcode);
        TransactionSignature signature = TransactionSignature.decodeFromFLO(signatureBytes, true);
        for (int i = 0 ; i < numKeys ; i++) {
     ...
     * logic is defined by <a href="https://github.com/flo/bips/blob/master/bip-0016.mediawiki">BIP 16</a>.</p>
     *
     ...
     * {@link org.floj.core.TransactionInput#verify(org.floj.core.TransactionOutput)} or
     * {@link org.floj.script.Script#correctlySpends(org.floj.core.Transaction, long, Script)}. This method
     * is useful if you need more precise control or access to the final state of the stack. This interface is very
     * likely to change in future.
     *
     * @deprecated Use {@link #executeScript(org.floj.core.Transaction, long, org.floj.script.Script, java.util.LinkedList, java.util.Set)}
     * instead.
     */
    @Deprecated
    ...
    private static void executeCheckSig(Transaction txContainingThis, int index, Script script, LinkedList<byte[]> stack,
        ...
        try {
            TransactionSignature sig  = TransactionSignature.decodeFromFLO(sigBytes, requireCanonical,
                verifyFlags.contains(VerifyFlag.LOW_S));
    ...
    private static int executeMultiSig(Transaction txContainingThis, int index, Script script, LinkedList<byte[]> stack,
        ...
        while (sigs.size() > 0) {
            ...
            try {
                TransactionSignature sig = TransactionSignature.decodeFromFLO(sigs.getFirst(), requireCanonical);
                Sha256Hash hash = txContainingThis.hashForSignature(index, connectedScript, (byte) sig.sighashFlags);
     ...
     * @deprecated Use {@link #correctlySpends(org.floj.core.Transaction, long, org.floj.script.Script, java.util.Set)}
    ...
    /**
     * Get the {@link org.floj.script.Script.ScriptType}.
