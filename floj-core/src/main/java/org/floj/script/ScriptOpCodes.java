...
/**
 * Various constants that define the assembly-like scripting language that forms part of the FLO protocol.
 * See {@link org.floj.script.Script} for details. Also provides a method to convert them to a string.
 */
