 ...
 * FLO serialization of the block header, <b>not</b> the header with the extra data as well.</p>
 * 
 * <p>A FullPrunedBlockStore also contains a map of hash+index to UTXO.  Again, the hash is
 * a standard FLO double-SHA256 hash of the transaction.</p>
 *
...
public interface FullPrunedBlockStore extends BlockStore, UTXOProvider {
    ...
    /**
     * Gets a {@link org.floj.core.UTXO} with the given hash and index, or null if none is found
     */
    UTXO getTransactionOutput(Sha256Hash hash, long index) throws BlockStoreException;
    
    /**
     * Adds a {@link org.floj.core.UTXO} to the list of unspent TransactionOutputs
     */
    void addUnspentTransactionOutput(UTXO out) throws BlockStoreException;
    
    /**
     * Removes a {@link org.floj.core.UTXO} from the list of unspent TransactionOutputs
