 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the FLO serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link org.floj.core.BlockChain#getChainHead()}
     * or perhaps {@link org.floj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link org.floj.core.NetworkParameters} of this store.
