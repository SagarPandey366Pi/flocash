...
public abstract class DatabaseFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    /**
     * Create a new store for the given {@link org.floj.core.NetworkParameters}.
    ...
    private void createNewStore(NetworkParameters params) throws BlockStoreException {
        try {
            ...
            // The coinbase in the genesis block is not spendable. This is because of how FLO Core inits
    ...
    protected void putUpdateStoredBlock(StoredBlock storedBlock, boolean wasUndoable) throws SQLException {
        try {
            ...
            s.setBytes(4, storedBlock.getHeader().cloneAsHeader().unsafeFLOSerialize());
     ...
     *
     * <p>The balance {@link org.floj.store.DatabaseFullPrunedBlockStore#getBalanceSelectSQL()} returns
