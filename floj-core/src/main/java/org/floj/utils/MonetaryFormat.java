...
public final class MonetaryFormat {
    ...
    /** Standard format for the FLO denomination. */
    public static final MonetaryFormat FLO = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mFLO denomination. */
    public static final MonetaryFormat MFLO = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µFLO denomination. */
    public static final MonetaryFormat UFLO = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 FLO. */
    public static final String CODE_FLO = "FLO";
    /** Currency code for base 1/1000 FLO. */
    public static final String CODE_MFLO = "mFLO";
    /** Currency code for base 1/1000000 FLO. */
    public static final String CODE_UFLO = "µFLO";
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard FLO notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes[0] = CODE_FLO;
        this.codes[3] = CODE_MFLO;
        this.codes[6] = CODE_UFLO;
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.floj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.floj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
