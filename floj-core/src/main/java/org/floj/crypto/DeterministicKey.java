 ...
 * <a href="https://github.com/flo/bips/blob/master/bip-0032.mediawiki">the BIP 32 specification</a> it is a pair
...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.floj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.floj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
