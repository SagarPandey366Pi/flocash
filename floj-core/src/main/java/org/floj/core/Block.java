...
import static org.floj.core.Sha256Hash.*;
...
/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the FLO system.
 ...
 * <a href="http://www.flo.org/flo.pdf">the FLO technical paper</a> for
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 2 * 60 * 60; // Same value as FLO Core.

    /**
     * A constant shared by the entire network: how large in bytes a block is allowed to be. One day we may have to
     * upgrade everyone to change this, so FLO can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /**
     * Constructs a block object from the FLO wire format.
     * @deprecated Use {@link FLOSerializer#makeBlock(byte[])} instead.
     */
    @Deprecated
    ...
    /**
     * Construct a block object from the FLO wire format.
    ...
    /**
     * Construct a block object from the FLO wire format. Used in the case of a block
     * contained within another message (i.e. for AuxPoW header).
     *
     * @param params NetworkParameters object.
     * @param payloadBytes FLO protocol formatted byte array containing message content.
     * @param offset The location of the first payload byte within the array.
    ...
    /**
     * <p>A utility method that calculates how much new FLO would be created by the block at the given height.
     * The inflation of FLO is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link org.floj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
     ...
     * Useful for non-FLO chains where the block header may not be a fixed
     * size.
     */
...
//        System.out.println("prevBlockHash:"+prevBlockHash);
//        System.out.println("getMerkleRoot():"+getMerkleRoot());
...
//        System.out.println("nonce:"+nonce);
     ...
     * below the target). Big endian.
     * https://www.lurkmore.com/view/Scrypt
     */
    @Override
    public Sha256Hash getPowHash() {
        ...
        try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
//            Sha256Hash.wrapReversed(Sha256Hash.hashTwice(bos.toByteArray()));
//            Sha256Hash powHash;
//             return Sha256Hash.wrap(Utils.scrypt_1024_1_1_256(Utils.reverseBytes(Sha256Hash.hashTwice(bos.toByteArray()))));
            Sha256Hash powHash=Sha256Hash.wrapReversed(Utils.scrypt_1024_1_1_256(bos.toByteArray()));
            return powHash;
//            return Sha256Hash.wrap(Utils.scrypt_1024_1_1_256(bos.toByteArray()));
        } catch (IOException e) {
            throw new RuntimeException(e); // Cannot happen.
        } catch (GeneralSecurityException e) {
			// scrypt_1024_1_1_256 errpr
    ...
    public Block cloneAsHeader() {
        ...
        copyFLOHeaderTo(block);
        return block;
    }

    /** Copy the block without transactions into the provided empty block. */
    protected final void copyFLOHeaderTo(final Block block) {
        block.nonce = nonce;
    ...
    public BigInteger getDifficultyTargetAsInteger() throws VerificationException {
        ...
        if (target.signum() <= 0 || target.compareTo(params.maxTarget) > 0)
            throw new VerificationException("Difficulty target is bad: " + target.toString(16));
        return target;
    }
...
//        BigInteger h = getHash().toBigInteger();
    ...
    /** Returns the version of the block data structure as defined by the FLO protocol. */
     ...
     * {@link org.floj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the FLO "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value, final int height) {
        ...
        coinbase.length = coinbase.unsafeFLOSerialize().length;
    ...
    /**
     * Create a block sending 50FLO as a coinbase transaction to the public key specified.
     ...
     * <a href="https://github.com/flo/bips/blob/master/bip-0034.mediawiki">BIP34: Height in Coinbase</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/flo/bips/blob/master/bip-0066.mediawiki">BIP66: Strict DER signatures</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/flo/bips/blob/master/bip-0065.mediawiki">BIP65: OP_CHECKLOCKTIMEVERIFY</a>.
     */
