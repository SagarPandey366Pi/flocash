 ...
 * FLO system, with the downside being a large cost in system resources. Fully verifying means all unspent
 ...
 * serve the full block chain to other clients, but it nevertheless provides the same security guarantees as FLO
 * Core does.</p>
 */
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://github.com/flo/bips/blob/master/bip-0030.mediawiki
            ...
            for (final Transaction tx : block.transactions) {
                ...
                if (!isCoinBase) {
                    ...
                    for (int index = 0; index < tx.getInputs().size(); index++) {
                        ...
                        // TODO: Check we're not spending the genesis transaction here. FLO Core won't allow it.
