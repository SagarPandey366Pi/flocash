...
import org.flo.NativeSecp256k1;
import org.flo.NativeSecp256k1Util;
import org.flo.Secp256k1Context;
 ...
 *
 * <p>ECKey also provides access to FLO Core compatible text message signing, as accessible via the UI or JSON-RPC.
 ...
 * are encoded using ASN.1/DER inside the FLO protocol.</p>
 *
...
public class ECKey implements EncryptableItem {
    ...
    // The parameters of the secp256k1 curve that FLO uses.
    ...
    /**
     * Construct an ECKey from an ASN.1 encoded private key. These are produced by OpenSSL and stored by FLO
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by FLO Core
     * in its wallet storage format.
     * @throws org.floj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the FLO protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * href="https://github.com/flo/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures">BIP62</a>.
         */
         ...
         * the same message. However, we dislike the ability to modify the bits of a FLO transaction after it's
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the FLO protocol, they are
     * usually encoded using ASN.1 format, so you want {@link org.floj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the FLO protocol, they are
     * usually encoded using DER format, so you want {@link org.floj.core.ECKey.ECDSASignature#encodeToDER()}
    ...
    /**
     * Signs a text message using the standard FLO messaging signing format and returns the signature as a base64
     * encoded string.
     *
    ...
    /**
     * Given an arbitrary piece of text and a FLO-format message signature encoded in base64, returns an ECKey
     * containing the public key that was used to sign it. This can then be compared to the expected public key to
     * determine if the signature was correct. These sorts of signatures are compatible with the FLO-Qt/bitcoind
     * format generated by signmessage/verifymessage RPCs and GUI menu options. They are intended for humans to verify
     * their communications with each other, hence the base64 format and the fact that the input is text.
     *
     * @param message Some piece of human readable text.
     * @param signatureBase64 The FLO-format message signature in base64
     ...
     * @throws org.floj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
    ...
    /**
     * Exports the private key in the form used by FLO Core's "dumpprivkey" and "importprivkey" commands. Use
     * the {@link org.floj.core.DumpedPrivateKey#toString()} method to get the string.
     *
