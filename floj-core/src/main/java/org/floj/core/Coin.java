...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * The number of satoshis equal to one flo.
     */
    ...
    /**
     * 0.001 FLOs, also known as 1 mFLO.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 FLOs, also known as 1 µFLO or 1 uFLO.
     */
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.FLO.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.FLO.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in FLO.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" FLO
     * </p>
     */
