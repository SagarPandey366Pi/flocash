...
public abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the FLO wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the flo wire format.
     *
     * @param stream
     * @throws IOException
     */
    ...
    /**
     * This method is a NOP for all classes except Block.  It is only declared in Message
