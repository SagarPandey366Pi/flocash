...
public class TransactionOutput extends ChildMessage {
    ...
    /**
     * <p>If the output script pays to an address as in <a href="https://flo.org/en/developer-guide#term-p2pkh">
     ...
     * the redeem script.</p>
     *
     * <p>P2SH is described by <a href="https://github.com/flo/bips/blob/master/bip-0016.mediawiki">BIP 16</a> and
     * <a href="https://flo.org/en/developer-guide#p2sh-scripts">documented in the FLO Developer Guide</a>.</p>
     *
     * @param networkParameters needed to specify an address
     ...
     *
     * <p>You probably should use {@link org.floj.core.TransactionOutput#getMinNonDustValue()} which uses
    ...
    public Coin getMinNonDustValue(Coin feePerKb) {
        ...
        final long size = this.unsafeFLOSerialize().length + 148;
