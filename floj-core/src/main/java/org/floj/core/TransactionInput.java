...
import org.floj.wallet.DefaultRiskAnalysis;
...
public class TransactionInput extends ChildMessage {
     ...
     * @see TransactionOutPoint#getConnectedRedeemData(org.floj.wallet.KeyBag)
     */
    @Nullable
     ...
     * <a href="https://github.com/flo/bips/blob/master/bip-0068.mediawiki">relative lock-time</a> enabled.
     */
    ...
    public TransactionInput duplicateDetached() {
        return new TransactionInput(params, null, floSerialize(), 0);
    }
