 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.floj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.floj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
     ...
     * and so on. This information is useful for {@link org.floj.wallet.CoinSelector} implementations to risk analyze
