...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.floj.core.PeerFilterProvider}s, a merged
 * {@link org.floj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.floj.core.PeerGroup} class internally.</p>
 *
