...
import org.floj.crypto.MnemonicException.MnemonicChecksumException;
import org.floj.crypto.MnemonicException.MnemonicLengthException;
import org.floj.crypto.MnemonicException.MnemonicWordException;
...
public class WalletSeed {
	...
	private void verifyAccount(Addresss address, JSONObject jsonAddress) throws Exception {
	...
	public Addresss getAddress() {
		...
		Addresss receiveAddress = receiveChain.getAddressAt(0);
