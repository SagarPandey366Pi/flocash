...
import static wallettemplate.ByteUtils.next11Bits;
import static wallettemplate.Sha256.sha256;
...
public class MnemonicGenerator {
    ...
    public static String createMnemonic(byte[] entropy, WordList wordList) throws NoSuchAlgorithmException {
        //prechecks
