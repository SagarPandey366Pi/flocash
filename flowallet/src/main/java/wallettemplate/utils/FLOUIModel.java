...
import org.floj.wallet.listeners.AbstractWalletEventListener;
...
/**
 * A class that exposes relevant flo stuff as JavaFX bindable properties.
 */
public class FLOUIModel {
    ...
    public FLOUIModel(Wallet wallet) {
        setWallet(wallet);
    }
