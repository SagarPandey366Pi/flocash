...
import validation.InvalidChecksumException;
import validation.InvalidWordCountException;
import validation.UnexpectedWhiteSpaceException;
import validation.WordNotFoundException;

import java.util.Arrays;
import java.util.Collection;
import java.util.Comparator;

import static wallettemplate.MnemonicGenerator.firstByteOfSha256;
import static wallettemplate.Normalization.normalizeNFKD;
