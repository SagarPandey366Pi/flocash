...
public class SendMoneyController {
    ...
    public void send(ActionEvent event) {
        ...
        try {
            ...
            //update the flo data in the transaction
            req.tx.setFloData(floData.getText().trim());
    ...
    private void askForPasswordAndRetry() {
        ...
        final String floDataStr = floData.getText();
        pwd.controller.aesKeyProperty().addListener((observable, old, cur) -> {
            ...
            screen.controller.floData.setText(floDataStr);
